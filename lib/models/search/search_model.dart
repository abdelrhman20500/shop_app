...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if(json["data"] is List) {
      data = json["data"] == null ? null : (json["data"] as List).map((e) => Product1.fromJson(e)).toList();
    }
...
class Product1 {
  ...
  Product1({this.id, this.price, this.oldPrice, this.discount, this.image, this.name, this.description});
